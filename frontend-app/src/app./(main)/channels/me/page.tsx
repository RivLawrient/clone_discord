...
import { TabBtn } from "../../_components/friend/tabBtn";
import { ListView } from "../../_components/friend/listView";
import { PendingView } from "../../_components/friend/pendingView";
import { AddView } from "../../_components/friend/addView";
  ...
  return (
    <div className="flex flex-1 flex-col bg-neutral-900">
      <div className="flex min-h-12 w-full items-center gap-4 border-t border-neutral-700 px-4 py-2 text-[14px]">
        ...
        {(friends.pending.length > 0 || friends.request.length > 0) && (
      ...
      <div className="flex h-full border-t border-neutral-700">
        <div className="w-full border-neutral-700">
          {tab == "all" || tab == "online" ? (
            ...
            <PendingView request={friends.request} pending={friends.pending} />
          ) : (
            <AddView />
          )}
        </div>
