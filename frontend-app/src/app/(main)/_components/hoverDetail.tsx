    ...
    <TooltipProvider disableHoverableContent delayDuration={0}>
      <Tooltip>
        ...
        <TooltipContent
          sideOffset={5}
          side={props.position}
          className="z-[50] flex h-[36px] items-center rounded-lg border border-neutral-700 bg-neutral-800 p-2 text-[14px] leading-none font-semibold text-neutral-300 opacity-100"
        >
          {props.label}
